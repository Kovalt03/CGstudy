...
#import c file for shader
#vertex shader input vetexPos, outPut Pos in clip space
g_vertex_shader_src = '''
#version 330 core
...
void main()
{
    ...
    gl_Position = vec4(vin_pos.x, vin_pos.y*-1, vin_pos.z, 1.0);
...
def main():
    ...
    # 2. Create VAO and activate VAO
    VAO = glGenVertexArrays(1)  # create a vertex array object ID and store it to VAO variable
    glBindVertexArray(VAO)      # activate VAO

    # create and activate VBO (vertex buffer object)
    # 3. Create VBO and activate ABO
